...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent, id, title, process, gui2msgcQueue,
        ...
        wx.Frame.__init__(self, parent, id, title, wx.Point(0, 0), wx.Size(720, 800))                  
        ...
        self.btnAct = wx.Button(panel, -1, "Active")
        self.btnAct.Enable(False)
        box.Add(self.btnAct, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 1)
        ...
        self.ggACMbat.SetBorderPadding(0)
        self.ggACMbat.SetDrawValue(draw=True, drawPercent=True, colour=wx.BLACK)
        ...
        self.ggCMPbat.SetBorderPadding(0)
        self.ggCMPbat.SetDrawValue(draw=True, drawPercent=True, colour=wx.BLACK)
...
Unused bits must be set to 0.  '''))
        ...
        # Clear and save log buttons at the bottom
        box = wx.BoxSizer(wx.HORIZONTAL)
